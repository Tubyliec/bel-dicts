...
Слоўнік створаны для пакета для правярання арфаграфіі [МТГ «RэЗервацыЯ»](https://spell.by-reservation.com).

Пакет створаны з дапамогай [Корпусу беларускай мовы](https://bnkorpus.info/).
